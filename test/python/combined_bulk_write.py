        ...
        for v in xrange(settings.VOLUMES):
            ...
            for m in xrange(settings.METRICS):
                ...
                for s in xrange(settings.SAMPLES_PER_HOUR):
                    ...
                    vbr = (1.0 + v * 1.0 / settings.VOLUMES) * math.sin((2 * math.pi * d / settings.DEVICES) + (1.0 + m) * math.pi * (
                            h * 3600.0 + s * 3600.0 / settings.SAMPLES_PER_HOUR) / (settings.HOURS * 3600.0))
                    vbw = (2.0 + v * 1.0 / settings.VOLUMES) * math.sin((2 * math.pi * d / settings.DEVICES) + (1.0 + m) * math.pi * (
                            h * 3600.0 + s * 3600.0 / settings.SAMPLES_PER_HOUR) / (settings.HOURS * 3600.0))
                    vir = (2.0 + v * 1.0 / settings.VOLUMES) * math.sin((2 * math.pi * d / settings.DEVICES) + (1.0 + m) * math.pi * (
                            h * 3600.0 + s * 3600.0 / settings.SAMPLES_PER_HOUR) / (settings.HOURS * 3600.0))
                    viw = (3.0 + v * 1.0 / settings.VOLUMES) * math.sin((2 * math.pi * d / settings.DEVICES) + (1.0 + m) * math.pi * (
                            h * 3600.0 + s * 3600.0 / settings.SAMPLES_PER_HOUR) / (settings.HOURS * 3600.0))
                    vlr = (4.0 + v * 1.0 / settings.VOLUMES) * math.sin((2 * math.pi * d / settings.DEVICES) + (1.0 + m) * math.pi * (
                            h * 3600.0 + s * 3600.0 / settings.SAMPLES_PER_HOUR) / (settings.HOURS * 3600.0))
                    vlw = (5.0 + v * 1.0 / settings.VOLUMES) * math.sin((2 * math.pi * d / settings.DEVICES) + (1.0 + m) * math.pi * (
                            h * 3600.0 + s * 3600.0 / settings.SAMPLES_PER_HOUR) / (settings.HOURS * 3600.0))

                    # 6 elements
                    elements = {"br": vbr, "bw": vbw, "ir": vir, "iw": viw, "lr": vlr, "lw": vlw}
                    dp.append([t, elements])
